...
import LandingAboutPreview from './landing/LandingAboutPreview'
import LandingLatestPosts from './landing/LandingLatestPosts'
import LandingLatestProjects from './landing/LandingLatestProjects'
...
import LandingGithub from './landing/LandingGithub'
        ...
        <myContext.Consumer>
            {context => (
                <div>
                    ...
                    <LandingAboutPreview {...props.markdownData} />
                    <LandingLatestPosts {...props} />
                    <LandingGithub />
                    <LandingLatestProjects {...props} />
                    <LandingBG className={context.isDark ? 'isDark' : 'isLight'} />
                </div>
            )}
        </myContext.Consumer>
    )
